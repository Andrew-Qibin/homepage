...
<blockquote style="color: black;  border-width: 12px; border-color: gray">
  <h4>Deeply Supervised Salient Object Detection with Short Connections</h4>
  <sub><p style="line-height:10px">Qibin Hou, Ming-Ming Cheng, Xiaowei Hu, Ali Borji, Zhuowen Tu, Philip Torr</p>
  <p style="line-height:10px">IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI), 2019</p>
  <a style="line-height:10px" href="https://arxiv.org/pdf/1611.04849.pdf">[Arxiv]   </a> <a style="line-height:10px" href="https://github.com/Andrew-Qibin/DSS">[Code]</a>
  </sub>
</blockquote>
